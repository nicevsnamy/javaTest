...
public class RenderHandler 
{
	...
	/* renderPixels = entire pixels of the image/sprite/rectangle/ect.
		imageWidth = width of the entire image
		imageHeight = height of the entire image
		xPosition = x position of render on screen
		yPosition = y postion of the render on screen
		xZoom = horizontal zoom
		yZoom = vertical zoom
		fixed = if the render should offset by camera position
		xOffset = horizontal offset into the image.
		yOffset = vertical offset into the image.
		renderWidth = width of the image to render
		renderHeight = height of the image to render
	*/
	public void renderArray(int[] renderPixels, int imageWidth, int imageHeight, int xPosition, int yPosition, int xZoom, int yZoom, boolean fixed, int xOffset, int yOffset, int renderWidth, int renderHeight) 
	{
